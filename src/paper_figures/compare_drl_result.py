...
path_1 = 'saved_files_global_combine_decay_0.99_lr_1e-05_batch_size_512_modify_reward_True_combine_0.05_more/_reward.csv'
df1 = pd.read_csv(path_1)
df2 = pd.read_csv(path_2)

# Loại bỏ các giá trị nhỏ hơn 0
# df1[['Agent 0', 'Agent 1', 'Agent 2', 'Agent 3', 'Agent 4']] = df1[['Agent 0', 'Agent 1', 'Agent 2', 'Agent 3', 'Agent 4']].clip(lower=0)
# df2[['Agent 0', 'Agent 1', 'Agent 2', 'Agent 3', 'Agent 4']] = df2[['Agent 0', 'Agent 1', 'Agent 2', 'Agent 3', 'Agent 4']].clip(lower=0)

# Tính tổng sau khi loại bỏ các giá trị nhỏ hơn 0
